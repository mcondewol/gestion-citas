                ...
                <form name="form-registration-doctor" id="form-registration-doctor" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="name" id="name" placeholder="Escriba el nombre" autocomplete="off">
                            <small id="name-warning" class="form-text text-muted"></small>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="specialty">Espcialidad</label>
                    ...
                    <div class="row mt-3">
                        <div class="col" id="div-btn-doctor">
...
<script>
    $(document).ready(function() {
        ...
        let buttons = `<div class='btn-dt'>
                            <button class='btn btn-outline-primary mr-2' onclick='openModal(1,1)'><i class='fa fa-plus-circle' style='color:rgb(26, 178, 255);'></i> <h8 class='hidden-xs hidden-sm hidden-md'>Nueva</h8></button>
                            <button class='btn btn-outline-secondary mr-2' onclick='openModal(2,1)'><i class='fa fa-pencil' style='color:rgb(89, 89, 166);'></i> <h8 class='hidden-xs hidden-sm hidden-md'>Modificar</h8></button>
                            <button class='btn btn-outline-danger mr-2' onclick='openModal(3,1)'><i class='fa fa-trash' style='color:#ef0202;'></i> <h8 class='hidden-xs hidden-sm hidden-md'>Eliminar</h8></button>
                            <button class='btn btn-outline-success' onclick='openModal(4,1)'><i class='fa fa-refresh' style='color:green;'></i> <h8 class='hidden-xs hidden-sm hidden-md'>Recargar</h8></button>
                        </div>`;
